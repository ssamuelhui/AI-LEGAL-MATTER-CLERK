...
class ExportPayload(BaseModel):
    ...
    def attribution(self) -> str:
        """The metadata attribution line required in every exported file."""
        files = ", ".join(self.source_files) if self.source_files else "(no files recorded)"
        return (
            f"Generated by Matter Clerk on {self.generated_on()}, "
            f"drawing on {files}. Model: {self.model}."
        )
